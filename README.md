...
### 情景导入
- 1.题目
  - [2016数学建模美赛C题。](http://blog.csdn.net/zhangtengyuan23/article/details/50605182)
- 2.Excel文件
  - [文件](https://github.com/Rasherpy/Openpyxl-Using/tree/master/Excel%20files)
  - 保存学校信息的Excel表**1.xlsx**
  - 学术名词解释说明的Excel表**2.xlsx**
  - 待投资学校名单的Excel表**3.xlsx**
### 需求分析
#### 一、从1.xlsx中筛选出投资院校，并将所有信息另存到record.xlsx中
解决方案：
